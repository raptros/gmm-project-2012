...
\newcite{rolleretal:12}, which means successfully getting Textgrounder up and
...
\newcite{rolleretal:12} show that using the centroid of locations of documents in
the grid cell as the cell's location results in more accurate predictions than
using the mean of document locations (as in \newcite{wing-baldridge:11}), even in
